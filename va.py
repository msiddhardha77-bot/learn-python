...
def virtual_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen().lower()
        edict = {'sweety':'pooja@codegnan.com'} #give mail ids
        toaddr = edict[to]
        ...
        mail.starttls()
        #login
        mail.login('poojach207@gmail.com','tiby gdup gbtz arfp') #enter mailid and app password make sure you enable less secure app access
